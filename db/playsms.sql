...
--
-- Table structure for table `playsms_gatewayAfricastalking_config`
--

DROP TABLE IF EXISTS `playsms_gatewayAfricastalking_config`;
CREATE TABLE `playsms_gatewayAfricastalking_config` (
  `c_timestamp` bigint(20) NOT NULL DEFAULT '0',
  `cfg_name` varchar(20) DEFAULT 'africastalking',
  `cfg_api_id` varchar(20) DEFAULT NULL,
  `cfg_username` varchar(100) DEFAULT NULL,
  `cfg_password` varchar(100) DEFAULT NULL,
  `cfg_module_sender` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `playsms_gatewayAfricastalking_config`
--
...
DROP TABLE IF EXISTS `playsms_gatewayAfricastalking`;
CREATE TABLE `playsms_gatewayAfricastalking` (
  `c_timestamp` bigint(20) NOT NULL DEFAULT '0',
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `local_smslog_id` int(11) NOT NULL DEFAULT '0',
  `remote_smslog_id` varchar(40) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `playsms_gatewayAfricastalking_log`
--
